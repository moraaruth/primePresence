...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-theme-primary">
      {/* Left panel */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-14 bg-theme-secondary border-r border-theme-subtle">
        ...
        <div>
          ...
          <h2 className="font-display text-4xl font-light text-theme-primary mb-4">
        ...
        <p className="text-theme-muted text-xs opacity-60">© {new Date().getFullYear()} Prime Presence</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <h1 className="font-display text-3xl font-light text-theme-primary mb-2">Create your account</h1>
          <p className="text-theme-muted text-sm mb-8">Start building your luxury website today.</p>
